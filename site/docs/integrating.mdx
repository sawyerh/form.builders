...
You will need to understand what existing business processes your form will support and you may need to find creative ways to find a wedge for your form to be introduced. Are staff manually entering data into a spreadsheet? Maybe you can create a process that outputs a CSV, which can then be imported into the spreadsheet. Are staff asking customers to email their forms? Your site could send the form as an email.

Below are a integration patterns that you might come across.
